...
{ id:'bx-cinematic-poster', ico:'🎞️', title:'超大字體電影感海報', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-3d-text-trap', ico:'🎞️', title:'3D立體文字包圍人物', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-collage-editorial', ico:'🧷', title:'前衛時尚雜誌拼貼', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-collage-variety', ico:'🧷', title:'綜藝節目普普漫畫海報', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-collage-taiwan', ico:'🧷', title:'台灣特色旅遊拼貼', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-collage-y2k', ico:'🧷', title:'Y2K日系少女雜誌拼貼', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-collage-vlog', ico:'🧷', title:'旅行vlog貼紙封面', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-collage-polaroid', ico:'🧷', title:'復古拍立得牆面', cat:'jpstyle', source:'數位時代・我是龐德',
...
{ id:'bx-grid-doodle', ico:'🔳', title:'手繪塗鴉九宮格（任意主題可套用）', cat:'grid9', source:'數位時代・我是龐德',
...
{ id:'bx-grid-doodle-white', ico:'🔳', title:'可愛白線塗鴉九宮格', cat:'grid9', source:'數位時代・我是龐德',
...
{ id:'bx-grid-bw-fashion', ico:'🔳', title:'黑白高對比時尚3×3網格', cat:'grid9', source:'數位時代・我是龐德',
...
{ id:'bx-grid-influencer', ico:'🔳', title:'AI網紅大頭貼（1主圖＋8小圖）', cat:'grid9', source:'數位時代・我是龐德',
...
{ id:'bx-event-windfest', ico:'🎪', title:'風神音樂祭像素海報', cat:'poster', source:'數位時代・我是龐德',
...
{ id:'bx-event-mummy', ico:'🎪', title:'埃及木乃伊展像素海報', cat:'poster', source:'數位時代・我是龐德',
...
{ id:'bx-event-calendar', ico:'🎪', title:'城市清新日曆問候圖', cat:'poster', source:'數位時代・我是龐德',
...
{ id:'bx-typo-graduation', ico:'🔤', title:'鏤空字體海報（畢業季主題）', cat:'poster', source:'數位時代・我是龐德',
...
{ id:'bx-typo-press', ico:'🔤', title:'字體壓制主體海報（任意主題可套用）', cat:'poster', source:'數位時代・我是龐德',
...
{ id:'bx-typo-deity', ico:'🔤', title:'神像造像信息海報', cat:'poster', source:'數位時代・我是龐德',
...
{ id:'mm-boxed-figure', ico:'🧸', title:'裝盒版Q版公仔模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-polly-pocket-transparent', ico:'🧸', title:'Polly Pocket透明展示公仔盒', cat:'doll', source:'瘋先生',
...
{ id:'mm-single-figure', ico:'🧸', title:'單獨公仔模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-glass-box-theme', ico:'🧸', title:'主題型高質感透明玻璃公仔盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-gundam-parts', ico:'🧸', title:'鋼彈版公仔模型零件指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-pet-box', ico:'🧸', title:'寵物公仔包裝盒模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-blindbox', ico:'🧸', title:'盲盒公仔模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-tomica-cbr', ico:'🧸', title:'日本Tomica玩具包裝盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-tomica-classic', ico:'🧸', title:'實體Tomica風格的玩具包裝盒', cat:'doll', source:'瘋先生',
...
{ id:'mm-barbie-box', ico:'🧸', title:'芭比娃娃包裝盒模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-tomica-display', ico:'🧸', title:'Tomica系列擬真玩具公仔展示盒', cat:'doll', source:'瘋先生',
...
{ id:'mm-tomica-display-alt', ico:'🧸', title:'Tomica擬真公仔包裝展示盒（簡化版）', cat:'doll', source:'瘋先生',
...
{ id:'mm-polaroid-3d', ico:'🧸', title:'拍立得3D立體照片公仔風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-polaroid-dynamic', ico:'🧸', title:'動態寫實拍立得照片公仔風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-retro-action-figure', ico:'🧸', title:'復古公仔玩具風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-blindbox-accessories', ico:'🧸', title:'公仔盲盒與配件風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-polly-pocket-round-couple', ico:'🧸', title:'圓形Polly Pocket風格公仔玩具盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-polly-pocket-single', ico:'🧸', title:'Polly Pocket風格單人公仔玩具盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-gashapon-round', ico:'🧸', title:'圓形透明扭蛋公仔指令', cat:'doll', source:'瘋先生',
  desc:'把照片中的動物轉成Q版扭蛋，透明扭蛋殼內放入寵物與代表性小物。',
  note:'適合寵物照片，可替換扭蛋內的小物。',
  prompt:`幫我用照片中的動物轉成Q版，做一個扭蛋，圓形的。扭蛋殼的顏色是透明的，並且在扭蛋內有一隻照片中的柴犬、一隻雞腿。` },

{ id:'mm-crystal-ball', ico:'🧸', title:'水晶球3D立體Q版公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-disney-crystal-ball', ico:'🧸', title:'迪士尼香檳金水晶球公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-pet-realistic-diorama', ico:'🧸', title:'寵物公仔寫實展示盒風格指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-tamagotchi-diorama', ico:'🧸', title:'電子機公仔風格指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-wood-house-doll', ico:'🧸', title:'木盒Q版人偶風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-milk-cup-station', ico:'🧸', title:'微型牛奶杯小盒風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-coconut-beach', ico:'🧸', title:'微型海灘度假村風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-soda-amusement', ico:'🧸', title:'微型遊樂園風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-3d-app-icon', ico:'🧸', title:'個人化Q版大頭照', cat:'doll', source:'瘋先生',
...
{ id:'mm-esports-avatar', ico:'🧸', title:'電競風格版大頭貼', cat:'doll', source:'瘋先生',
...
{ id:'mm-gashapon-machine', ico:'🧸', title:'立體3D扭蛋機公仔風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-claw-machine', ico:'🧸', title:'立體3D夾娃娃機公仔風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-gashapon-cute', ico:'🧸', title:'可愛的3D扭蛋機風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-handshake', ico:'🧸', title:'3D立體公仔握手風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-birthday-box', ico:'🧸', title:'半開生日快樂主題盒風格', cat:'doll', source:'瘋先生',
...
{ id:'mm-storybook-japan', ico:'🧸', title:'立體書造型公仔風格（日本旅行版）', cat:'doll', source:'瘋先生',
...
{ id:'mm-storybook-vietnam', ico:'🧸', title:'立體書造型公仔風格（越南旅行版）', cat:'doll', source:'瘋先生',
...
{ id:'mm-proposal-scene', ico:'🧸', title:'Q版公仔求婚3D場景', cat:'doll', source:'瘋先生',
...
{ id:'mm-room-diorama', ico:'🧸', title:'特殊個人化3D公仔場景與房間', cat:'doll', source:'瘋先生',
...
{ id:'mm-jewelbox-couple', ico:'🧸', title:'紀念收藏Q版公仔盒', cat:'doll', source:'瘋先生',
...
{ id:'mm-jewelbox-love-story', ico:'🧸', title:'紀念收藏Q版公仔盒（LOVE Story珠寶盒版）', cat:'doll', source:'瘋先生',
...
{ id:'mm-funko-pop', ico:'🧸', title:'Funko Pop 公仔製作', cat:'doll', source:'瘋先生',
...
{ id:'mm-pixar-3d', ico:'🧸', title:'皮克斯3D人物公仔指令', cat:'doll', source:'瘋先生',
  desc:'以皮克斯3D風格重繪照片，人物用可愛公仔呈現。最簡短好上手的一組指令。',
  prompt:`以皮克斯3D風格重繪這張照片，人物用可愛公仔呈現。` },

{ id:'mm-photo-frame-wedding', ico:'🧸', title:'相框公仔人偶', cat:'doll', source:'瘋先生',
...
{ id:'mm-tilt-shift-diorama', ico:'🧸', title:'微型立體場景', cat:'doll', source:'瘋先生',
  desc:'運用移軸攝影技法，把照片內人物Q版化，依照原本角色造型、穿著和動作呈現。',
  prompt:`微型立體場景呈現，運用移軸攝影的技法，將照片內人物Q版，並且依照原本角色造型、穿著和動作呈現` },

{ id:'mm-rpg-card', ico:'🧸', title:'RPG風格角色對應製作', cat:'doll', source:'瘋先生',
...
{ id:'mm-titanic', ico:'🧸', title:'鐵達尼號Q版人偶浪漫畫面製作', cat:'doll', source:'瘋先生',
...
{ id:'mm-airpods-case', ico:'🧸', title:'AirPods耳機殼公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-sanrio-tv', ico:'🧸', title:'微縮袖珍立體電視場景公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-carousel-music-box', ico:'🧸', title:'木質旋轉音樂盒公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-popsicle', ico:'🧸', title:'夏天冰棒公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-lego-diorama', ico:'🧸', title:'樂高LEGO公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-lego-baggie', ico:'🧸', title:'透明塑膠袋樂高公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-lego-box', ico:'🧸', title:'樂高外盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-lego-miniature', ico:'🧸', title:'樂高公仔風格縮影指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-bandai-gundam', ico:'🧸', title:'萬代鋼彈模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-outfit-breakdown', ico:'🧸', title:'Q版穿搭公仔風指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-city-model', ico:'🧸', title:'公仔風格城市模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-gashapon-capsule', ico:'🧸', title:'扭蛋膠囊公仔風格指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-isometric-room', ico:'🧸', title:'極簡等距風格的3D模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-cola-bottle', ico:'🧸', title:'可口可樂瓶公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-arcade-cabinet', ico:'🧸', title:'90年代大型街機公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-plush-doll', ico:'🧸', title:'Q版短毛玩偶公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-collectible-office', ico:'🧸', title:'高端收藏等級模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-inflatable', ico:'🧸', title:'充氣娃娃模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-card-illustration', ico:'🧸', title:'卡牌人像插畫模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-polaroid-camera-3d', ico:'🧸', title:'拍立得3D數位公仔模型指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-ramen-diorama', ico:'🧸', title:'豚骨拉麵微景觀公仔模型指令', cat:'doll', source:'瘋先生',
  desc:'在一碗豚骨拉麵的大碗上創造微型景觀，3D Q版人物公仔鬆弛地吃著拉麵，旁邊坐著可愛公仔。',
  prompt:`請幫我在一碗豚骨拉麵的大碗上創造一個微型景觀。
主題3D Q版人物公仔（根據圖1的照片），很鬆弛的吃著碗裡的拉麵，旁邊坐著一隻可愛的公仔。` },

{ id:'mm-chanel-dollhouse', ico:'🧸', title:'迷你豪華娃娃屋指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-city-weather', ico:'🧸', title:'小型3D城市氣象圖指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-imac-scene', ico:'🧸', title:'3D立體iMac場景公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-gameboy-room', ico:'🧸', title:'GameBoy遊戲主機立體場景指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-tamagotchi-egg', ico:'🧸', title:'立體寵物蛋公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-round-openbox', ico:'🧸', title:'開盒狀態的圓形公仔盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-couple-egypt', ico:'🧸', title:'情侶公仔搭配景點外盒指令', cat:'doll', source:'瘋先生',
...
{ id:'mm-dead-sea-coconut', ico:'🧸', title:'擬真泡澡椰子殼公仔指令', cat:'doll', source:'瘋先生',
...
{ id:'mt-tamagotchi', ico:'🐣', title:'專屬電子雞合照', cat:'threads', source:'經理人',
...
{ id:'mt-y2k-lowangle', ico:'📸', title:'Y2K仰拍超廣角照片', cat:'threads', source:'經理人',
...
{ id:'mt-stamp-zh', ico:'📮', title:'橡皮章旅行田野筆記（繁中版）', cat:'threads', source:'經理人',
...
{ id:'mt-stamp-en', ico:'📮', title:'橡皮章旅行田野筆記（英文原版）', cat:'threads', source:'經理人',
...
{ id:'mt-illustration-zh', ico:'🖌️', title:'極簡手繪藝術出版海報（繁中版）', cat:'threads', source:'經理人',
...
{ id:'mt-illustration-en', ico:'🖌️', title:'極簡手繪藝術出版海報（英文原版）', cat:'threads', source:'經理人',
...
{ id:'mt-vintage-poster-zh', ico:'🚄', title:'復古日本觀光海報（繁中版）', cat:'threads', source:'經理人',
...
{ id:'mt-vintage-poster-en', ico:'🚄', title:'復古日本觀光海報（英文原版）', cat:'threads', source:'經理人',
